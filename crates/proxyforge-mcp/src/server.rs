//! MCP Server implementation for ProxyForge
//!
...
impl McpServer {
    ...
    fn handle_list_resources(&self, request: JsonRpcRequest) -> JsonRpcResponse {
        let resources = vec![
            Resource {
                uri: "proxyforge://traffic".to_string(),
                name: "Traffic".to_string(),
                description: Some("Captured HTTP traffic".to_string()),
                mime_type: Some("application/json".to_string()),
            },
            Resource {
                uri: "proxyforge://sessions".to_string(),
                name: "Sessions".to_string(),
                description: Some("Debugging sessions".to_string()),
                mime_type: Some("application/json".to_string()),
            },
            Resource {
                uri: "proxyforge://config".to_string(),
                name: "Configuration".to_string(),
                description: Some("ProxyForge configuration".to_string()),
                mime_type: Some("application/json".to_string()),
            },
        ];
