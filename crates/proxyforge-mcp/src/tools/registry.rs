...
impl ToolRegistry {
    /// Create a new tool registry with all ProxyForge tools
    pub fn new() -> Self {
        let tools = vec![
            ...
            Tool {
                name: "proxyforge_get_traffic_entry".to_string(),
            ...
            Tool {
                name: "proxyforge_search_traffic".to_string(),
            ...
            Tool {
                name: "proxyforge_get_traffic_count".to_string(),
            ...
            Tool {
                name: "proxyforge_clear_traffic".to_string(),
            ...
            // Mock tools
            Tool {
                name: "proxyforge_list_mocks".to_string(),
            ...
            Tool {
                name: "proxyforge_create_mock".to_string(),
            ...
            Tool {
                name: "proxyforge_delete_mock".to_string(),
            ...
            Tool {
                name: "proxyforge_toggle_mock".to_string(),
            ...
            // Breakpoint tools
            Tool {
                name: "proxyforge_list_breakpoints".to_string(),
            ...
            Tool {
                name: "proxyforge_create_breakpoint".to_string(),
            ...
            Tool {
                name: "proxyforge_delete_breakpoint".to_string(),
            ...
            // Replay tools
            Tool {
                name: "proxyforge_replay_request".to_string(),
            ...
            Tool {
                name: "proxyforge_save_request".to_string(),
            ...
            Tool {
                name: "proxyforge_list_saved_requests".to_string(),
            ...
            // Session tools
            Tool {
                name: "proxyforge_list_sessions".to_string(),
            ...
            Tool {
                name: "proxyforge_create_session".to_string(),
            ...
            Tool {
                name: "proxyforge_export_session".to_string(),
            ...
            Tool {
                name: "proxyforge_import_session".to_string(),
                ...
                input_schema: json!({
                    ...
                    "properties": {
                        "session_data": {
                            "type": "object",
                            "description": "The session data to import (HAR format or ProxyForge export)"
                        }
                    },
            ...
            Tool {
                name: "proxyforge_switch_session".to_string(),
            ...
            // Export tools
            Tool {
                name: "proxyforge_export_curl".to_string(),
