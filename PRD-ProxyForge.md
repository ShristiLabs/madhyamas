...
# ProxyForge - Open Source Web Debugging Proxy
...
### Product Name
**ProxyForge** - An open-source, cross-platform HTTP/HTTPS debugging proxy with a modern web-based UI, built in Rust for performance and reliability.
...
```
Client                ProxyForge              Upstream Server
  │                       │                         │
  │─── ClientHello ──────▶│                         │
  │                       │                         │
  │◀── ServerHello ───────│  (with ProxyForge CA)  │
  │                       │                         │
  │─── Certificate Verify─▶│                         │
  │                       │                         │
  │◀── ProxyForge Cert ───│                         │
...
├── Cargo.toml
├── crates/
│   ├── proxyforge-core/          # Core proxy logic
│   │   ├── src/
│   │   │   ├── proxy/
│   │   │   ├── tls/
│   │   │   ├── traffic/
...
│   │   │   └── lib.rs
│   │   └── Cargo.toml
│   ├── proxyforge-cli/           # CLI interface
│   │   ├── src/
│   │   │   └── main.rs
│   │   └── Cargo.toml
│   └── proxyforge-plugins/       # Plugin SDK
│       ├── src/
│       └── Cargo.toml
├── web/                          # React frontend
│   ├── package.json
...
| Feature | ProxyForge | Charles | mitmproxy | Proxyman | HTTP Toolkit |
|---------|------------|---------|-----------|----------|--------------|
| **Open Source** | ✅ | ❌ | ✅ | ❌ | ✅ |
| **Free** | ✅ | ❌ ($50) | ✅ | Freemium | ✅ |
